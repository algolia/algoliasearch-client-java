...
public class UtilsTest {
  ...
  public void secureKeys() throws AlgoliaException {
    assertThat(
      Utils.generateSecuredApiKey("182634d8894831d5dbce3b3185c50881", new Query().setTagFilters(Collections.singletonList("(public,user1)")), null)
    ...
    assertThat(
      Utils.generateSecuredApiKey("182634d8894831d5dbce3b3185c50881", new Query().setTagFilters(Collections.singletonList("(public,user1)")).setUserToken("42"), null)
