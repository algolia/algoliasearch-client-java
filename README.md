...
1. [List indices - `listIndices`](#list-indices---listindices)
1. [Delete index - `delete`](#delete-index---delete)
1. [Clear index - `clear`](#clear-index---clear)
1. [Copy index - `clear`](#copy-index---clear)
1. [Move index - `moveTo`](#move-index---moveto)
...
//Sync version
SearchFacetResult result = index.searchForFacetValues("category", "phone");

//Async version
CompletableFuture<SearchFacetResult> result = index.searchForFacetValues("category", "phone");
```
...
//Sync version
SearchFacetResult result = index.searchFacet("category", "phone", query);

//Async version
CompletableFuture<SearchFacetResult> result = index.searchFacet("category", "phone", query);
```
...
and the string that is inserted after the highlighted parts in the query result
...
You can also Search for entries around a given latitude/longitude with a given precision for ranking.
