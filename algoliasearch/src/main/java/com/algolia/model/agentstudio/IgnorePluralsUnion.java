...
/** IgnorePluralsUnion */
@JsonDeserialize(using = IgnorePluralsUnion.Deserializer.class)
public interface IgnorePluralsUnion {
  // IgnorePluralsUnion as List<SupportedLanguage> wrapper.
  static IgnorePluralsUnion of(List<SupportedLanguage> value) {
    return new ListOfSupportedLanguageWrapper(value);
  }

  // IgnorePluralsUnion as Boolean wrapper.
  static IgnorePluralsUnion of(Boolean value) {
    return new BooleanWrapper(value);
  }

  // IgnorePluralsUnion as List<SupportedLanguage> wrapper.
  @JsonSerialize(using = ListOfSupportedLanguageWrapper.Serializer.class)
  class ListOfSupportedLanguageWrapper implements IgnorePluralsUnion {
  ...
  class BooleanWrapper implements IgnorePluralsUnion {
  ...
  class Deserializer extends JsonDeserializer<IgnorePluralsUnion> {

    private static final Logger LOGGER = Logger.getLogger(Deserializer.class.getName());

    @Override
    public IgnorePluralsUnion deserialize(JsonParser jp, DeserializationContext ctxt) throws IOException {
      ...
      if (tree.isArray()) {
        try (JsonParser parser = tree.traverse(jp.getCodec())) {
          ...
          return new IgnorePluralsUnion.ListOfSupportedLanguageWrapper(value);
        } catch (Exception e) {
      ...
      if (tree.isBoolean()) {
        try (JsonParser parser = tree.traverse(jp.getCodec())) {
          ...
          return new IgnorePluralsUnion.BooleanWrapper(value);
        } catch (Exception e) {
          // deserialization failed, continue
    ...
    @Override
    public IgnorePluralsUnion getNullValue(DeserializationContext ctxt) throws JsonMappingException {
      return null;
    }
  }
}
