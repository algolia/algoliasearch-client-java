 ...
 * with the specified `objectID` doesn't exist in the specified index, this action adds the record
 * to the index). - `partialUpdateObjectNoCreate`: same as `partialUpdateObject`, but with
