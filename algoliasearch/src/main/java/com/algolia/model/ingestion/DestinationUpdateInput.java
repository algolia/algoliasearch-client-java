...
public class DestinationUpdateInput {
  ...
  public DestinationUpdateInput setIndexName(String indexName) {
  ...
  public DestinationUpdateInput setRecordType(RecordType recordType) {
  ...
  public DestinationUpdateInput setAttributesToExclude(List<String> attributesToExclude) {
    this.attributesToExclude = attributesToExclude;
    return this;
  }

  public DestinationUpdateInput addAttributesToExclude(String attributesToExcludeItem) {
  ...
  public boolean equals(Object o) {
    ...
    DestinationUpdateInput destinationUpdateInput = (DestinationUpdateInput) o;
    return (
      Objects.equals(this.indexName, destinationUpdateInput.indexName) &&
      Objects.equals(this.recordType, destinationUpdateInput.recordType) &&
      Objects.equals(this.attributesToExclude, destinationUpdateInput.attributesToExclude)
    );
  }
